  ...
  return (
    <Card className="@container/card">
      <CardHeader>
        ...
        <CardDescription>Přehled podle kategorií za poslední období</CardDescription>
        <CardAction>
          <ToggleGroup
            type="single"
            value={timeRange}
          ...
          <Select value={timeRange} onValueChange={setTimeRange}>
            <SelectTrigger className="flex w-40 @[767px]/card:hidden" size="sm" aria-label="Vyber období">
      ...
      <CardContent className="px-2 pt-4 sm:px-6 sm:pt-6">
        <ChartContainer config={chartConfig} className="aspect-auto h-[250px] w-full">
          <AreaChart data={chartData}>
            ...
            />
            <Area dataKey="kancelar" type="natural" fill="var(--chart-1)" stroke="var(--chart-1)" stackId="a" />
            <Area dataKey="cestovne" type="natural" fill="var(--chart-2)" stroke="var(--chart-2)" stackId="a" />
            <Area dataKey="zabava" type="natural" fill="var(--chart-3)" stroke="var(--chart-3)" stackId="a" />
          </AreaChart>
        </ChartContainer>
      </CardContent>
    </Card>
